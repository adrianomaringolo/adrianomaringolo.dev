...
![Selo I do SOLID sobre um contrato único carregando quatro capacidades diferentes, do qual só uma parte é usada por cada extensão, contrastado com contratos menores em que cada extensão depende só do que usa](/blog/2026-08-24-solid-interface-segregation-principle/hero-isp.svg)
