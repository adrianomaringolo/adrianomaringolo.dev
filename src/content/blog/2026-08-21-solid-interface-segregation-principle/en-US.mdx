...
![SOLID's I badge above a single contract carrying four different capabilities, of which each extension only uses a slice, contrasted with smaller contracts where every extension depends only on what it uses](/blog/2026-08-21-solid-interface-segregation-principle/hero-isp.svg)
