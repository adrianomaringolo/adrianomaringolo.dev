...
export default function ProjetosPage() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Site portfólio para designer com galeria interativa e animações.",
    ...
    },
    {
      ...
      description:
        "Aplicativo web para gerenciamento de tarefas com drag & drop.",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground text-center mb-12 max-w-3xl mx-auto text-pretty">
              Confira alguns dos projetos que desenvolvi, desde websites
