      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-3xl font-bold text-center mb-4">{tAbout('techs')}</h2>
            <p className="mb-12 text-sm text-center text-muted-foreground">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-center mb-4">{tAbout('howIWork')}</h2>
            <p className="mb-12 text-sm text-center text-muted-foreground">
